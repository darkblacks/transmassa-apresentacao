      ...
      <main className="slide1-layout">
        <div className="slide1-content">
          ...
          <p className="slide1-footer-text">
            Consolidação mensal de indicadores de KM, combustível, manutenção,
            serviços, custos gerenciais e desempenho da frota.
          </p>
        </div>
